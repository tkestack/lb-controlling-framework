...
import (
	...
	v1beta1 "git.tencent.com/lb-controlling-framework/pkg/client-go/informers/internalversion/v1beta1"
...
type SharedInformerFactory interface {
	...
	Lbcf() v1beta1.Interface
}

func (f *sharedInformerFactory) Lbcf() v1beta1.Interface {
