...
const (
	...
	UpdateLBHook       = "updateLoadBalancer"
...
type ValidateBackendRequest struct {
	...
	OldParameters map[string]string `json:"OldParameters"`
}
...
type BackendRegResult struct {
	...
	PersistentInfo map[string]string        `json:"persistentInfo"`
}

type DeregBackendRequest struct {
	LBInfo   map[string]string `json:"lbInfo"`
...
func callDeregisterBackend(driver *v1beta1.LoadBalancerDriver, req *DeregBackendRequest) (*DeregisterBackendResponse, error) {
